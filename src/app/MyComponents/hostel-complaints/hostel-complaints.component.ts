...
@Component({
  selector: 'app-hostel-complaints',
  templateUrl: './hostel-complaints.component.html',
  styleUrls: ['./hostel-complaints.component.css']
})
export class HostelComplaintsComponent implements OnInit {
...
getAllSACComplaints() {
  this.sacService.getAllComplaints('Hostel').subscribe(res=>{
