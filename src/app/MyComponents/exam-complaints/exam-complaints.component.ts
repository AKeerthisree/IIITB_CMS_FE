...
@Component({
  selector: 'app-exam-complaints',
  templateUrl: './exam-complaints.component.html',
  styleUrls: ['./exam-complaints.component.css']
})
export class ExamComplaintsComponent implements OnInit {
...
getAllComplaints() {
  this.sacService.getAllComplaints('Exam').subscribe(res=>{
