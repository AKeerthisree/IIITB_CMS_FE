...
@Component({
  selector: 'app-place-com-complaints',
  templateUrl: './place-com-complaints.component.html',
  styleUrls: ['./place-com-complaints.component.css']
})
export class PlaceComComplaintsComponent implements OnInit {
...
getAllSACComplaints() {
  this.sacService.getAllComplaints('PlaceCom').subscribe(res=>{
