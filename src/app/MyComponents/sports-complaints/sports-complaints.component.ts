...
@Component({
  selector: 'app-sports-complaints',
  templateUrl: './sports-complaints.component.html',
  styleUrls: ['./sports-complaints.component.css']
})
export class SportsComplaintsComponent implements OnInit {
...
getAllSACComplaints() {
  this.sacService.getAllComplaints('Sports').subscribe(res=>{
